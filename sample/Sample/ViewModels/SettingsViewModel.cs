...
public class SettingsViewModel : AbstractViewModel
{
    public SettingsViewModel(IUserDialogs dialogs) : base(dialogs)
    {
        StandardSettings = new Command(() =>
        {
            ...
            Result("Default Settings Loading - Now run samples");
        });

        LoadAbnormalSettings = new Command(() =>
        {
            ...
            Result("Abnormal Settings Loaded - Now run samples");
        });
    }
